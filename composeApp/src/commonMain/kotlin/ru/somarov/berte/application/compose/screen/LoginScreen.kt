...
import ru.somarov.berte.application.compose.UIError
import ru.somarov.berte.application.compose.UIScreen
import ru.somarov.berte.application.compose.UIWait
import ru.somarov.berte.infrastructure.BResult
import ru.somarov.berte.infrastructure.onLoading
...
fun LoginScreen(
    ...
    when (val ld = loading) {
        ...
        is BResult.Error -> UIError.Error(ld.error.message ?: "error")
        is BResult.Loading -> UIWait.Wait()
        is BResult.Success -> {
            println("ZZZ success ${ld.data}")
